...
public class COMMAND_TalkUnMute implements ServerCommand {

	@Override
	public void performCommand(Member m, TextChannel c, Message msg) {
		if(m.hasPermission(Permission.VOICE_MUTE_OTHERS) || m.getRoles().contains(m.getGuild().getRoleByBot(Main.vars.get(m.getGuild().getId()).get(VarType.TECHNIK)))) {
